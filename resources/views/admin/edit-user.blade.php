                ...
                <div class="card-body text-white p-4">
                    <div class="row align-items-center">
                        <div class="col-md-8 mb-3 mb-md-0">
                            <h1 class="mb-2 fw-bold fs-3 fs-md-2">
                        ...
                        <div class="col-md-4 text-md-end">
                            <a href="{{ route('admin.users') }}" class="btn btn-light btn-lg d-flex align-items-center justify-content-center justify-content-md-start">
                    ...
                    <form action="{{ route('admin.users.update', $user->id) }}" method="POST">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                @enderror
                                <div class="form-text">
                                    <small><i class="fas fa-info-circle me-1"></i>Leave blank to keep current password. Minimum 8 characters if changing.</small>
                                </div>
                            </div>
                            ...
                            <div class="card border-0" style="background: var(--light-cream);">
                                <div class="card-body p-3">
                                    <h6 class="card-title mb-2" style="color: var(--primary-navy);">
                                        <i class="fas fa-info-circle me-1"></i>Current User Details
                                    </h6>
                                    <div class="row">
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <span class="badge bg-{{ $user->role === 'admin' ? 'danger' : ($user->role === 'lecturer' ? 'warning' : 'info') }}">
                                                {{ ucfirst($user->role) }}
                                            </span>
                                        </div>
                                        <div class="col-md-4">
                        ...
                        <div class="d-flex flex-column flex-md-row justify-content-between align-items-center gap-3 gap-md-0">
                            <a href="{{ route('admin.users') }}" class="btn btn-outline-secondary w-100 w-md-auto">
